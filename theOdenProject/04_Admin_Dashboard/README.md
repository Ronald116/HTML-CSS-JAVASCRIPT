...
Choose your own fonts! The design example uses Roboto, which is available with Google fonts. (You may want to review the [More Text Styles](https://www.theodinproject.com/lessons/intermediate-html-and-css-more-text-styles) Lesson for information about how to include external fonts in your projects).
...
Before you move on, we would love it if you could submit your feedback on [the Intermediate HTML and CSS course](https://docs.google.com/forms/d/e/1FAIpQLSf_hNwIjvqcPZyl9Lx41mgJNQKp04qOro03SI8ABw4Zp7U_4w/viewform?pli=1).
